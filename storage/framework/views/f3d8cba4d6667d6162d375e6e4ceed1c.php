<?php $__env->startSection('head_title', $restaurant->restaurant_name.' Menu'); ?>
      ...
      <div id="main_menu" class="box_style_2">
        ...
        <table class="table table-striped cart-list">
          ...
          <tr>
            ...
            <td><strong>$ <?php echo e($menu_item->price); ?></strong></td>
            <td class="options">
                <?php if(Auth::check()): ?>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/pages/restaurants_menu.blade.php ENDPATH**/ ?>