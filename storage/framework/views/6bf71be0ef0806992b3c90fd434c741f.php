...
<div id="main">
	<div class="page-header">
		...
		<a href="<?php echo e(URL::to('admin/menu')); ?>" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
	...
	<?php endif; ?>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                <?php echo Form::open(array('url' => array('admin/menu/addmenu'),'class'=>'form-horizontal padding-15','name'=>'menu_form','id'=>'menu_form','role'=>'form','enctype' => 'multipart/form-data')); ?> 
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/admin/pages/owner/addeditmenu.blade.php ENDPATH**/ ?>