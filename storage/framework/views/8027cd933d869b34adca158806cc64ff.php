<?php $__env->startSection('head_title', 'My Orders'); ?>
    ...
    <div class="container margin_60">
      ...
      <tbody>
        ...
        <?php $__currentLoopData = $order_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <td><strong class="">$<?php echo e(\App\Menu::getMenunfo($order_item->item_id)->price); ?></strong></td>
                <td><strong class="">$<?php echo e($order_item->item_price); ?></strong></td>
...
<?php echo $__env->make("app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/pages/my_order.blade.php ENDPATH**/ ?>