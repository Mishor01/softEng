    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="images/" alt=""> </b>
        ...
        ***********************************-->
        <div class="nk-sidebar">           
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="homecooks.html" aria-expanded="false">
                            <i class="icon-badge menu-icon"></i><span class="nav-text">Home Cooke</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="customers.html" aria-expanded="false">
        ...
        <!--**********************************
            Sidebar end
        ***********************************-->
<?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>