...
<div id="main">
	<div class="page-header">
		...
		<div class="pull-right">
			<a href="<?php echo e(URL::to('admin/menu/addmenu')); ?>" class="btn btn-primary">Add <i class="fa fa-plus"></i></a>
		</div>
		<h2>Menu Items</h2>
...
<?php echo $__env->make("admin.admin_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/admin/pages/owner/menu.blade.php ENDPATH**/ ?>