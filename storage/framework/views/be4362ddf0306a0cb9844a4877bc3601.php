...
<header style="background: rgba(80, 164, 47, 0.98);box-shadow: 0 2px 10px -2px rgba(0, 0, 0, 0.41);display: inline-block;line-height: 0;position: relative;width: 100%;z-index: 999;margin-bottom:20px;">
    <div style="width: 1100px;margin:0 auto;">
      <div style="margin: 12px 0;text-align:center;color:#fff;font-size:16px;"> <a href="<?php echo e(url('/')); ?>" target="_blank"><img src="<?php echo e(URL::asset('upload/')); ?>" alt="" ></a> </div>      
    </div>
</header>
<div style="width: 1100px;margin:0 auto;">    
<h2 style="color: #565656;font-size: 14px;font-weight: 600;padding:5px 10px;text-align:left;">Hi,</h2>
<p style="padding:0 10px;margin: 0 0 10px;line-height:22px;color:#444">New order placed by <?php echo e($name); ?>!</p> 
...
<div style="float: left;margin:0px 0;padding: 8px 0; width:1100px;">					
	<table height="100%" width="100%">
	  ...
	  <tbody>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  <td style="width:40%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><?php echo e($order->item_name); ?></td>
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><?php echo e($order->quantity); ?></td>
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><?php echo e(\App\Menu::getMenunfo($order->item_id)->price); ?></td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><?php echo e($order->item_price); ?>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">&nbsp;</td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;"><b>Amount Payable:$ <?php echo e($sum); ?></b>
		  </td>
		</tr>							
	  </tbody>				  
	</table>
...
<div style="width: 1100px;margin:0 auto;">
  <p style="color: #fff;font-size: 13px;margin: 0;text-align: center;text-transform: none;">Copyright © <?php echo e(date('Y')); ?>. All rights reserved.</p>
</div>
</div>
</body>
</html>
 <?php /**PATH C:\laragon\www\Ghoroa_baburchi\resources\views/emails/order_item_owner_admin.blade.php ENDPATH**/ ?>