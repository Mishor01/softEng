...
class OrderController extends MainAdminController
{
    ...
    public function owner_orderlist()    { 
         ...
         if ($restaurant && isset($restaurant['id'])) {
            ...
            // Handle the case when the $restaurant variable is null or doesn't have an 'id' element.
            // You can assign a default value or perform any necessary error handling.
            $restaurant_id = null; // or any other default value
        }
