...
@section('head_title', 'My Orders')

@section('head_url', Request::url())

@section("content")
 
<div class="sub-banner" style="background:url({{ URL::asset('upload/')}}) no-repeat center top;">
    <div class="overlay">
      <div class="container">
        <h1>My Orders</h1>
      </div>
    ...
    <div class="container margin_60">
      ...
      <tbody>
        ...
        @foreach($order_list as $order_item)
                ...
                <td><strong class="">${{ \App\Menu::getMenunfo($order_item->item_id)->price }}</strong></td>
                <td><strong class="">${{$order_item->item_price}}</strong></td>
