...
<header style="background: rgba(80, 164, 47, 0.98);box-shadow: 0 2px 10px -2px rgba(0, 0, 0, 0.41);display: inline-block;line-height: 0;position: relative;width: 100%;z-index: 999;margin-bottom:20px;">
    <div style="width: 1100px;margin:0 auto;">
      <div style="margin: 12px 0;text-align:center;color:#fff;font-size:16px;"> <a href="{{ url('/') }}" target="_blank"><img src="{{ URL::asset('upload/')}}" alt="" ></a> </div>      
    </div>
</header>
<div style="width: 1100px;margin:0 auto;">    
	...
	<table height="100%" width="100%">
	  ...
	  <tbody>
		...
		<tr style="border-bottom:1px solid #ccc">                      
		  ...
		  <td style="width:12%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">{{ \App\Menu::getMenunfo($order->item_id)->price }}</td>
		  <td style="width:38%;color:#565656;text-align:left;padding:10px;vertical-align: middle;">{{$order->item_price}}
...
<div style="width: 1100px;margin:0 auto;">
  <p style="color: #fff;font-size: 13px;margin: 0;text-align: center;text-transform: none;">Copyright © {{date('Y')}}. All rights reserved.</p>
</div>
</div>
</body>
</html>
